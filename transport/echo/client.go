...
func NewClient[Req, Res any](method string, tgt *url.URL, enc EncodeClientRequestFunc[Req], dec gkit.EncodeDecodeFunc[*http.Response, Res], options ...ClientOption[Req, Res]) *Client[Req, Res] {
...
type EncodeClientRequestFunc[Req any] func(context.Context, *http.Request, Req) error

func makeCreateRequestFunc[Req any](method string, target *url.URL, enc EncodeClientRequestFunc[Req]) gkit.EncodeDecodeFunc[Req, *http.Request] {
