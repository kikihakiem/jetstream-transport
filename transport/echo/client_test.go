...
func TestHTTPClient(t *testing.T) {
	...
	client := echotransport.NewClient[struct{}, TestResponse](
		"GET",
		mustParse(server.URL),
		encode,
		decode,
		echotransport.ClientBefore[struct{}, TestResponse](echotransport.SetRequestHeader(headerKey, headerVal)),
		echotransport.ClientAfter[struct{}, TestResponse](afterFunc),
	)
...
func TestHTTPClientBufferedStream(t *testing.T) {
	...
	client := echotransport.NewClient[struct{}, TestResponse](
		...
		encode,
		decode,
		echotransport.BufferedStream[struct{}, TestResponse](true),
	)
...
func TestClientFinalizer(t *testing.T) {
	...
	client := echotransport.NewClient[struct{}, TestResponse](
		...
		encode,
		decode,
		echotransport.ClientFinalizer[struct{}, TestResponse](func(ctx context.Context, err error) {
...
func TestEncodeJSONRequest(t *testing.T) {
	...
	client := echotransport.NewClient[any](
		"POST",
		serverURL,
		echotransport.EncodeJSONRequest,
...
func TestSetClient(t *testing.T) {
	...
	client := echotransport.NewClient[any, string](
		"GET",
		&url.URL{},
		encode,
		decode,
		echotransport.SetClient[any, string](testHttpClient),
	).Endpoint()
...
func TestNewExplicitClient(t *testing.T) {
	...
	client := echotransport.NewExplicitClient(req, dec)
